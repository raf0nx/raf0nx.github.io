...
//Twój adres email
$address = "jpawlowski989@gmail.com";
...
$e_body = "Napisał do Ciebie $name. Wiadomość." . PHP_EOL . PHP_EOL;
$e_content = "\"$comments\"" . PHP_EOL . PHP_EOL;
$e_reply = "Możesz napisać do $name email, $email";
...
if(mail($address, $e_subject, $msg, $headers)) {
	...
	echo "<h3>Email został wysłany pomyślnie.</h3>";
	echo "<p>Dziękujemy <strong>$name</strong>, Twoja wiadomość została wysłana.</p>";
	echo "</div>";
	echo "</fieldset>";
